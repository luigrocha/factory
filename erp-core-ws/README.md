...
```
cd existing_repo
git remote add origin https://gitlab.crsoft.org/microservices/cartonplast/cp-core-ws.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.crsoft.org/microservices/cartonplast/cp-core-ws/-/settings/integrations)
