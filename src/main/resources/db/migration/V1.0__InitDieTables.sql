...
(
    ...
    CATFAB_DESCRIPTION   VARCHAR(128) NOT NULL,
    CATFAB_OBSERVATION   VARCHAR(128),
...
(
    ...
    CATTRO_NAME         VARCHAR(128)   NOT NULL,
    ...
    CATTRO_UPDATED_BY    VARCHAR(16),
    CATTRO_CREATED_AT    TIMESTAMP,
    CATTRO_UPDATED_AT    TIMESTAMP,
...
/* Table: CATMAQ_CAT                                            */
/*==============================================================*/
CREATE TABLE CATMAQ_CAT
(
    ID_CATMAQ_CAT_CODE      INT         NOT NULL AUTO_INCREMENT,
    CATMAQ_CAT_NAME             VARCHAR(32) NOT NULL,
    CATMAQ_CAT_VALID_FROM       TIMESTAMP,
    CATMAQ_CAT_VALID_TO         TIMESTAMP   NULL,
    CATMAQ_CAT_CREATED_BY       VARCHAR(16),
    CATMAQ_CAT_UPDATED_BY       VARCHAR(16),
    CATMAQ_CAT_CREATED_AT       TIMESTAMP,
    CATMAQ_CAT_UPDATED_AT       TIMESTAMP,
    PRIMARY KEY (ID_CATMAQ_CAT_CODE)
);

ALTER TABLE CATMAQ_CAT
    COMMENT 'MAQUINA CATALOGO';
...
(
    ...
    XID_CATMAQ_CAT_CODE     INT         NOT NULL,
    CATMAQ_NAME             VARCHAR(32) NOT NULL,
    CATMAQ_WIDTH_EXT        DOUBLE,
    CATMAQ_HAS_DESB         BOOL,
    CATMAQ_ABILITY_PELL     INT,
    CATMAQ_DESCRIPTION      VARCHAR(128),
    CATMAQ_OBSERVATION      VARCHAR(128),
...
(
    ...
    CATSTATUS_IS_VISIBLE BOOL NOT NULL,
    CATSTATUS_IS_DEFAULT BOOL NOT NULL,
    CATSTATUS_INDEX      INT NOT NULL,
...
/* Table: CATPRODTRO                                            */
/*==============================================================*/
CREATE TABLE CATPRODTRO
(
    ID_CATPRODTRO_CODE   INT NOT NULL AUTO_INCREMENT,
    XID_CATSTATUS_CODE   VARCHAR(4) NOT NULL,
    CATPRODTRO_PTROQ     VARCHAR(8) NOT NULL,
    CATPRODTRO_NAME      VARCHAR(128) NOT NULL,
    CATPRODTRO_AREA      DECIMAL(8,4),
    CATPRODTRO_LENGTH    DECIMAL(8,4),
    CATPRODTRO_WIDTH     DECIMAL(8,4),
    CATPRODTRO_GSMDIS    DECIMAL(8,4),
    CATPRODTRO_VALID_FROM TIMESTAMP,
    CATPRODTRO_VALID_TO  TIMESTAMP NULL,
    CATPRODTRO_CREATED_BY VARCHAR(16),
    CATPRODTRO_UPDATED_BY VARCHAR(16),
    CATPRODTRO_CREATED_AT TIMESTAMP,
    CATPRODTRO_UPDATED_AT TIMESTAMP,
    PRIMARY KEY (ID_CATPRODTRO_CODE)
);

ALTER TABLE CATPRODTRO COMMENT 'PRODUCTO TRROQUELADO';

/*==============================================================*/
/* Index: CAIPRODTRO_PTROQ                                      */
/*==============================================================*/
CREATE INDEX CAIPRODTRO_PTROQ ON CATPRODTRO(CATPRODTRO_PTROQ);

ALTER TABLE CATMAQ ADD CONSTRAINT XID_CATMAQ_CODE_XID_CATMAQ_CAT_CODE FOREIGN KEY (XID_CATMAQ_CAT_CODE)
    REFERENCES CATMAQ_CAT (ID_CATMAQ_CAT_CODE) ON DELETE RESTRICT;

ALTER TABLE CATPRODTRO ADD CONSTRAINT XID_CATPRODTRO_CODE_XID_CATSTATUS_CODE FOREIGN KEY (XID_CATSTATUS_CODE)
...
ALTER TABLE CATTRO ADD CONSTRAINT XID_CATTRO_CODE_XID_CATPRODTRO_CODE FOREIGN KEY (XID_CATPRODTRO_CODE)
